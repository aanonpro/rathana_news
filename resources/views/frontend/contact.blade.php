...
@section('title','thonea | Contact Us')
@section('contents')
	<!-- Breadcrumb -->
	<div class="container">
							...
							<ul class="p-t-35">
								<li class="flex-wr-sb-s p-b-30">
									<a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
										<img src="{{url('')}}/frontend/images/popular-post-04.jpg" alt="IMG">
									</a>
								...
								<li class="flex-wr-sb-s p-b-30">
									<a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
										<img src="{{url('')}}/frontend/images/popular-post-05.jpg" alt="IMG">
									</a>
								...
								<li class="flex-wr-sb-s p-b-30">
									<a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
										<img src="{{url('')}}/frontend/images/popular-post-06.jpg" alt="IMG">
									</a>
